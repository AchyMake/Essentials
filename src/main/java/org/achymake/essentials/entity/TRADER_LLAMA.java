...
public class TRADER_LLAMA {
    ...
    private boolean setup() {
        ...
        config.set("levels.1.main-hand.item", "diamond_sword");
        config.set("levels.1.main-hand.amount", 1);
        config.set("levels.1.main-hand.drop-chance", 0.25);
        config.set("levels.1.off-hand.item", "diamond");
        config.set("levels.1.off-hand.amount", 1);
        config.set("levels.1.off-hand.drop-chance", 0.25);
        config.set("levels.1.helmet.item", "diamond_helmet");
        config.set("levels.1.helmet.amount", 1);
        config.set("levels.1.helmet.drop-chance", 0.25);
        config.set("levels.1.chestplate.item", "diamond_chestplate");
        config.set("levels.1.chestplate.amount", 1);
        config.set("levels.1.chestplate.drop-chance", 0.25);
        config.set("levels.1.leggings.item", "diamond_leggings");
        config.set("levels.1.leggings.amount", 1);
        config.set("levels.1.leggings.drop-chance", 0.25);
        config.set("levels.1.boots.item", "diamond_boots");
        config.set("levels.1.boots.amount", 1);
        config.set("levels.1.boots.drop-chance", 0.25);
