...
public class PLAYER {
    ...
    private void setup() {
        ...
        config.set("disable-block-interact.BELL", false);
        config.set("disable-target.VILLAGER", false);
        config.set("disable-damage.ITEM", false);
        config.set("disable-damage.ITEM_FRAME", false);
        config.set("disable-damage.GLOW_ITEM_FRAME", false);
        config.set("disable-damage.PAINTING", false);
        config.set("disable-damage.LEASH_KNOT", false);
        config.set("disable-damage.ARMOR_STAND", false);
