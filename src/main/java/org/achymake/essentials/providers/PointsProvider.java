...
import org.achymake.vaultextra.services.PointsHandler;
import org.bukkit.OfflinePlayer;
import org.bukkit.plugin.ServicePriority;

public class PointsProvider implements PointsHandler {
    private final Essentials ess;
    public PointsProvider(Essentials ess) {
        this.ess = ess;
    }
    public void register() {
        ess.getServer().getServicesManager().register(PointsHandler.class, this, ess, ServicePriority.Normal);
    }
    @Override
