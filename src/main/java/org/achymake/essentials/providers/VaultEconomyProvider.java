...
public class VaultEconomyProvider implements Economy {
    ...
    private OfflinePlayer getOfflinePlayer(String playerName) {
        return getInstance().getServer().getOfflinePlayer(playerName);
    }
    @Override
    ...
    public boolean hasAccount(String playerName) {
        return getUserdata(getOfflinePlayer(playerName)).exists();
    }
    @Override
    public boolean hasAccount(OfflinePlayer player) {
        return getUserdata(player).exists();
    }
    @Override
    ...
    public double getBalance(String playerName) {
        return getUserdata(getOfflinePlayer(playerName)).getAccount();
    }
    @Override
    public double getBalance(OfflinePlayer player) {
        return getUserdata(player).getAccount();
    }
    @Override
    ...
    public boolean has(String playerName, double amount) {
        return getUserdata(getOfflinePlayer(playerName)).getAccount() >= amount;
    }
    @Override
    public boolean has(OfflinePlayer player, double amount) {
        return getUserdata(player).getAccount() >= amount;
    }
    @Override
    ...
    public boolean createPlayerAccount(String playerName) {
        getUserdata(getOfflinePlayer(playerName)).reload();
        return true;
    }
    @Override
