...
public class Message {
    ...
    private void setup() {
        ...
        config.addDefault("commands.entity.disable-explode", "{0}&6 disable-explode is now&f {1}");
        config.addDefault("commands.entity.disable-change-block", "{0}&6 disable-change-block is now&f {1}");
        config.addDefault("commands.entity.disable-interact", "{0}&6 disable-interact&f {1}&6 is now&f {2}");
        config.addDefault("commands.entity.disable-target", "{0}&6 disable-target&f {1}&6 is now&f {2}");
        config.addDefault("commands.entity.disable-entity-damage", "{0}&6 disable-damage&f {1}&6 is now&f {2}");
        config.addDefault("commands.entity.disable-hanging-break", "{0}&6 disable-hanging-break&f {1}&6 is now&f {2}");
        config.addDefault("commands.entity.disable-spawn-reason", "{0}&6 disable-spawn-reason&f {1}&6 is now&f {2}");
        config.addDefault("commands.exp.self", "&6Your exp is&f {0}");
        config.addDefault("commands.exp.other", "{0}&6 exp is&f {1}");
        config.addDefault("commands.exp.add", "&6You added&f {0}&6 exp to&f {1}");
        config.addDefault("commands.exp.remove", "&6You removed&f {0}&6 exp to&f {1}");
        config.addDefault("commands.exp.set", "&6You set&f {0}&6 exp to&f {1}");
        ...
        config.addDefault("commands.kit.insufficient-funds", "&cYou do not have&a {0}&c to receive the&f {1}&c kit");
        ...
        config.addDefault("commands.lvl.self", "&6Your lvl is&f {0}");
        config.addDefault("commands.lvl.other", "{0}&6 lvl is&f {1}");
        config.addDefault("commands.lvl.add", "&6You added&f {0}&6 lvl to&f {1}");
        config.addDefault("commands.lvl.remove", "&6You removed&f {0}&6 lvl to&f {1}");
        config.addDefault("commands.lvl.set", "&6You set&f {0}&6 lvl to&f {1}");
        ...
        config.addDefault("commands.time.set", "{0}&6 set time to&f {1}");
        config.addDefault("commands.time.add", "{0}&6 added&f {1}&6 time");
        config.addDefault("commands.time.remove", "{0}&6 removed&f {1}&6 time");
        ...
        config.addDefault("commands.tpa.target.notify", "{0}&6 has sent you a tpa request");
        ...
        config.addDefault("commands.tpahere.sender.notify", "&6You have sent a tpahere request to&f {0}");
        ...
        config.addDefault("commands.world.difficulty.success", "{0}&6 difficulty has changed to&f {1}");
        config.addDefault("commands.world.difficulty.invalid", "{0}&c is not a difficulty");
        config.addDefault("commands.world.info.title", "{0}&6 Info:");
        config.addDefault("commands.world.info.pvp", "&6pvp&f: {0}");
        config.addDefault("commands.world.info.difficulty", "&6difficulty&f: {0}");
        config.addDefault("commands.world.info.seed", "&6seed&f: {0}");
        config.addDefault("commands.world.info.environment", "&6environment&f: {0}");
        config.addDefault("commands.world.info.gamerule.title", "&6gamerule:");
        config.addDefault("commands.world.info.gamerule.listed", "&6{0}&f: {1}");
