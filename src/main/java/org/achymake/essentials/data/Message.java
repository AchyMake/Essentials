...
public class Message {
    ...
    private void setup() {
        ...
        config.set("commands.anvil.target", "{0}&6 opened anvil for you");
        ...
        config.set("commands.bank.withdraw.non-sufficient-funds", "&cYou do not have&a {0}&c to withdraw from bank");
        ...
        config.set("commands.bank.deposit.non-sufficient-funds", "&cYou do not have&a {0}&c to deposit");
        config.set("commands.bank.deposit.minimum", "&cYou have to deposit at least&a {0}");
        config.set("commands.cartography.target", "{0}&6 opened cartography table for you");
        ...
        config.set("commands.eco.non-sufficient-funds", "{0}&c does not have&a {1}");
        ...
        config.set("commands.enchant.air", "&cYou have to hold an item");
        config.set("commands.enchanting.target", "{0}&6 opened enchanting table for you");
        ...
        config.set("commands.entity.disable-block-damage", "{0}&6 disable-block-damage is now&f {1}");
        config.set("commands.entity.disable-block-change", "{0}&6 disable-block-change is now&f {1}");
        config.set("commands.entity.disable-block-interact", "{0}&6 disable-block-interact&f {1}&6 is now&f {2}");
        config.set("commands.entity.disable-target", "{0}&6 disable-target&f {1}&6 is now&f {2}");
        config.set("commands.entity.disable-damage", "{0}&6 disable-damage&f {1}&6 is now&f {2}");
        config.set("commands.entity.disabled-spawn-reason", "{0}&6 disabled-spawn-reason&f {1}&6 is now&f {2}");
        ...
        config.set("commands.feed.target", "{0}&6 satisfied your starvation");
        ...
        config.set("commands.grindstone.target", "{0}&6 opened grindstone for you");
        ...
        config.set("commands.hat.air", "&cYou have to hold an item");
        ...
        config.set("commands.heal.target", "{0}&6 satisfied your health");
        ...
        config.set("commands.pay.non-sufficient-funds", "&cYou do not have&a {0}&c to pay&f {1}");
        ...
        config.set("commands.sell.air", "&cYou have to hold an item");
        ...
        config.set("commands.setworth.air", "&cYou have to hold an item");
        ...
        config.set("commands.tpa.target.notify", "{0} has sent you a tpa request");
        ...
        config.set("commands.tpahere.sender.notify", "&6You have sent a tpa request to&f {0}");
