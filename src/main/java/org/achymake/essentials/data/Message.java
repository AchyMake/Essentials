...
public class Message {
    ...
    private void setup() {
        ...
        config.addDefault("commands.anvil.target", "{0}&6 opened anvil for you");
        ...
        config.addDefault("commands.ban.success", "&6You banned&f {0}&6 for&f {1} {2}");
        ...
        config.addDefault("commands.bank.withdraw.non-sufficient-funds", "&cYou do not have&a {0}&c to withdraw from bank");
        ...
        config.addDefault("commands.bank.deposit.non-sufficient-funds", "&cYou do not have&a {0}&c to deposit");
        config.addDefault("commands.bank.deposit.minimum", "&cYou have to deposit at least&a {0}");
        config.addDefault("commands.cartography.target", "{0}&6 opened cartography table for you");
        ...
        config.addDefault("commands.enchant.air", "&cYou have to hold an item");
        config.addDefault("commands.enchanting.target", "{0}&6 opened enchanting table for you");
        ...
        config.addDefault("commands.feed.target", "{0}&6 satisfied your starvation");
        ...
        config.addDefault("commands.grindstone.target", "{0}&6 opened grindstone for you");
        ...
        config.addDefault("commands.hat.air", "&cYou have to hold an item");
        ...
        config.addDefault("commands.heal.target", "{0}&6 satisfied your health");
        ...
        config.addDefault("commands.pay.non-sufficient-funds", "&cYou do not have&a {0}&c to pay&f {1}");
        ...
        config.addDefault("commands.repair.air", "&cYou have to hold an item");
        ...
        config.addDefault("commands.sell.air", "&cYou have to hold an item");
        ...
        config.addDefault("commands.setworth.air", "&cYou have to hold an item");
        ...
        config.addDefault("commands.world.create.folder-exists", "{0}&c folder already exists use add instead");
        config.addDefault("commands.world.create.post-create", "{0}&6 is about to be created");
        config.addDefault("commands.world.create.title", "{0}&6 has been created with the following:");
        config.addDefault("commands.world.create.environment", "&6environment&f: {0}");
        config.addDefault("commands.world.create.seed", "&6seed&f: {0}");
        config.addDefault("commands.world.add.post-add", "{0}&6 is about to be added");
        config.addDefault("commands.world.add.title", "{0}&6 has been created with the following&f:");
        config.addDefault("commands.world.add.environment", "&6environment&f: {0}");
        config.addDefault("commands.world.add.seed", "&6seed&f: {0}");
        config.addDefault("commands.world.add.folder-invalid", "{0}&c folder does not exists use create instead");
        config.addDefault("commands.world.add.world-exists", "{0}&c already exists");
